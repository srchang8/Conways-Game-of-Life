...
class StandardEngine: EngineProtocol {
    ...
    var grid : GridProtocol {
        didSet {
            ...
            NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(StandardEngine.didResetGridWithNotification(_:)), name: ResetPressedNotificationName, object: nil)
        }
    }
    ...
    func didResetGridWithNotification(notification: NSNotification) {
        // Resetting the timer upon reseting the grid
